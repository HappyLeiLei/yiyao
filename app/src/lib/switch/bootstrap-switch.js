    ...
    var init = function init() {
      ...
      setTimeout(function() {
        return (
          ...
          _this3.$wrapper.addClass(prvgetClass.call(_this3, 'animate'))
        );
      }, 50);
    };
  ...
  function prvlabelHandlers() {
    ...
    var handlers = {
      ...
      'mousemove.bootstrapSwitch touchmove.bootstrapSwitch': function mousemoveBootstrapSwitchTouchmoveBootstrapSwitch(
        ...
        var difference =
          (event.pageX || event.originalEvent.touches[0].pageX) - dragStart;
        event.preventDefault();
        ...
        class: function _class() {
          return getClasses(_this9.options, _this9.$element.attr('id'))
            ...
            .concat(
              ...
              prvgetClasses.call(_this9, _this9.options.wrapperClass)
            )
            .join(' ');
        }
      });
      ...
      this.$element.on('switchChange.bootstrapSwitch', function() {
        ...
        if (_this9.options.onSwitchChange.apply(element, args) === false) {
          if (_this9.$element.is(':radio')) {
            $('[name="' + _this9.$element.attr('name') + '"]').trigger(
    ...
    _createClass(BootstrapSwitch, [
      ...
      },
      {
        ...
        value: function wrapperClass(value) {
          ...
          this.$wrapper.removeClass(
            prvgetClasses.call(this, this.options.wrapperClass).join(' ')
          );
